...
@property (nonatomic, nullable, copy) NSString *inReplyToTweetID;
 ...
 */
- (instancetype)initWithInReplyToTweetID:(nullable NSString *)inReplyToTweetID text:(nullable NSString *)text attachment:(nullable id<TWTRSETweetAttachment>)attachment place:(nullable id<TWTRSEGeoPlace>)place usernames:(nullable NSArray<NSString *> *)usernames hashtags:(nullable NSArray<NSString *> *)hashtags NS_DESIGNATED_INITIALIZER;
