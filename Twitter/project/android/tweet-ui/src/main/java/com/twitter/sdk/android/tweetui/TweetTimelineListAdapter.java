...
public class TweetTimelineListAdapter extends TimelineListAdapter<Tweet> {
    ...
    protected ReplyClickListener replyClickListener;
    protected TweetViewClickListener tweetViewClickListener;
    ...
    public TweetTimelineListAdapter(Context context, Timeline<Tweet> timeline) {
        this(context, timeline, R.style.tw__TweetLightStyle, null, null, null);
    }

    TweetTimelineListAdapter(Context context, Timeline<Tweet> timeline, int styleResId,
                             Callback<Tweet> cb, ReplyClickListener listener, TweetViewClickListener tweetViewClickListener) {
        this(context, new TimelineDelegate<>(timeline), styleResId, cb, TweetUi.getInstance(), listener, tweetViewClickListener);
    }

    TweetTimelineListAdapter(Context context, TimelineDelegate<Tweet> delegate, int styleResId,
                             Callback<Tweet> cb, TweetUi tweetUi, ReplyClickListener listener, TweetViewClickListener tweetViewClickListener) {
        super(context, delegate);
        this.styleResId = styleResId;
        this.actionCallback = new ReplaceTweetCallback(delegate, cb);
        this.tweetUi = tweetUi;
        this.replyClickListener = listener;
        this.tweetViewClickListener = tweetViewClickListener;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            tv.setReplyClickListener(replyClickListener);
            rowView = tv;
        } else {
            ((BaseTweetView) rowView).setTweet(tweet);
        }
        rowView.setOnClickListener(view -> tweetViewClickListener.onTweetViewClick(tweet));
        return rowView;
    }
    ...
    public static class Builder {
        ...
        private TweetViewClickListener tweetViewClickListener;
        /**
        ...
        public Builder setReplyClickListener(ReplyClickListener listener) {
            this.replyClickListener = listener;
            return this;
        }
        public Builder setTweetViewClickListener(TweetViewClickListener listener) {
            this.tweetViewClickListener = listener;
            return this;
        }
        /**
        ...
        public TweetTimelineListAdapter build() {
            if (timelineFilter == null) {
                return new TweetTimelineListAdapter(context, timeline, styleResId, actionCallback, replyClickListener, tweetViewClickListener);
            } else {
                ...
                return new TweetTimelineListAdapter(context, delegate, styleResId, actionCallback,
                        TweetUi.getInstance(), replyClickListener, tweetViewClickListener);
            }
        }
    }
}
