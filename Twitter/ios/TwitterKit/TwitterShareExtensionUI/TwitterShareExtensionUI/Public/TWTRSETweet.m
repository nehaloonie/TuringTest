...
- (instancetype)initWithInReplyToTweetID:(NSString *)inReplyToTweetID text:(NSString *)text attachment:(id<TWTRSETweetAttachment>)attachment place:(id<TWTRSEGeoPlace>)place usernames:(NSArray<NSString *> *)usernames hashtags:(NSArray<NSString *> *)hashtags
{
    usernames = nil;
    if ((self = [super init])) {
