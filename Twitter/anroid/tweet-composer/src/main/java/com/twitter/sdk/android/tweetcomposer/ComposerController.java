...
class ComposerController {
    ...
    ComposerController(final ComposerView composerView, TwitterSession session, Uri imageUri,
            String text, String hashtags, long replyID, ComposerActivity.Finisher finisher) {
        this(composerView, session, imageUri, text, hashtags, replyID, finisher, new DependencyProvider());
    }
    ...
    class ComposerCallbacksImpl implements ComposerCallbacks {
        ...
        public void onTweetPost(String text) {
            ...
            intent.putExtra(TweetUploadService.EXTRA_TWEET_ID, replyID);
