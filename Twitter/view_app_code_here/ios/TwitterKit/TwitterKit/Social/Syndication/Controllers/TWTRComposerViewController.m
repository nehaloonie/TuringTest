...
+ (instancetype)composerWithTweet:(TWTRTweet *)tweet
{
    return (TWTRComposerViewController *)[[TWTRSharedComposerWrapper alloc] initWithTweet:tweet];
}

+ (instancetype)initWithReply:(nullable NSString *)tweetId names:(NSArray<NSString*> *)screenNames
{
    return (TWTRComposerViewController *)[[TWTRSharedComposerWrapper alloc] initWithReply:tweetId withUsers:screenNames];
}
