...
{
    self.srcTweet = tweet;
    return [self initWithText:nil image:nil attachment:nil];
    
}
- (instancetype)initWithReply:(NSString*)tweetID withUsers:(NSArray<NSString *>*)users
{
...
- (TWTRSETweet *)tweetWithText:(NSString *)text attachment:(id<TWTRSETweetAttachment>)attachment image:(UIImage *)image
{
    ...
    return [[TWTRSETweet alloc] initWithInReplyToTweetID:self.tweetID text:text attachment:tweetAttachment place:nil usernames:self.userNames hashtags:nil];
}
